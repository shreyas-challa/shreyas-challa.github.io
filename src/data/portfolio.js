...
export const cves = [
  {
    id: 'CVE-2026-46395',
    summary: 'HAXcms (Node.js backend): private key disclosure via broken HMAC implementation, allowing unauthenticated attackers to forge admin JWTs.',
    status: 'Published',
  ...
  {
    id: 'CVE-2026-46394',
    summary: 'HAXcms (PHP backend): OS command injection in the Git.php library via unsanitized parameters passed to proc_open(), enabling arbitrary command execution.',
    status: 'Reserved',
